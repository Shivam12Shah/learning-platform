...
const Home = () => {
  ...
  return (
    <div className="px-20 w-full max-sm:w-full max-sm:px-0 ">
      <div className="herodiv flex text-[#8B77E8] my-16 px-10  max-sm:flex-col-reverse">
        <div className="left flex flex-col items-start justify-center w-[35%] max-sm:w-full">
          <h3 className="text-5xl font-semibold max-sm:text-3xl max-sm:w-full">
        ...
        <div className="right w-[65%] max-sm:w-full max-sm:bg-red-400 ">
          <img
